...
export default function InvitationCardSection({ onShare }: InvitationCardSectionProps) {
  ...
  return (
    <section className="relative px-4 py-10 bg-[#F5EFEB] flex flex-col items-center">
      {/* Decorative Label */}
      <div className="mb-6 flex items-center justify-center gap-3">
        <div className="h-px w-12 bg-gradient-to-r from-transparent to-[#B8860B]/40" />
        <span className="font-serif text-xs uppercase tracking-[0.35em] text-[#916E32] font-semibold">
